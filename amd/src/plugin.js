...
const MODEL_INFO = {
  ...
  'dall-e-3': {
    badge: 'CLASSIQUE', badgeColor: '#2563eb',
    description: 'Modèle éprouvé et stable. Excellent pour les illustrations artistiques, les scènes narratives et les styles créatifs. Moins performant pour le texte dans les images.',
    strengths: ['Illustrations artistiques et créatives', 'Scènes narratives et ambiances', 'Styles variés : watercolor, sketch, cartoon', 'Bien documenté, large communauté'],
    qualities: [['standard','Standard — qualité normale'],['hd','HD — haute définition (plus cher)']],
    defaultQuality: 'standard',
    sizes: [['1024x1024','1024×1024 — Carré'],['1792x1024','1792×1024 — Paysage'],['1024x1792','1024×1792 — Portrait']],
    defaultSize: '1792x1024',
    tip: '<strong>💡 DALL-E 3 :</strong> Idéal pour les illustrations artistiques. Utilisez <em>hd</em> pour les détails fins. Évitez ce modèle si l\'image doit contenir du texte lisible.',
    gradient: 'linear-gradient(135deg,#2563eb,#1d4ed8)',
    tipBg: '#eff6ff', tipBorder: '#2563eb',
...
function buildCostTab() {
  ...
  <div id="tab-cost" style="display:none;">
    ...
    <!-- Tableau DALL-E 3 -->
    <h3 style="font-size:.9rem;color:#2563eb;margin:0 0 8px;">DALL-E 3 — Coûts estimés par image</h3>
    <table style="width:100%;border-collapse:collapse;font-size:.83rem;margin-bottom:18px;">
      <thead>
        <tr style="background:#eff6ff;">
          <th style="padding:8px 10px;text-align:left;border:1px solid #e5e7eb;color:#4b5563;">Qualité</th>
          <th style="padding:8px 10px;text-align:center;border:1px solid #e5e7eb;color:#4b5563;">1024×1024</th>
          <th style="padding:8px 10px;text-align:center;border:1px solid #e5e7eb;color:#4b5563;">1792×1024</th>
          <th style="padding:8px 10px;text-align:center;border:1px solid #e5e7eb;color:#4b5563;">Usage recommandé</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style="padding:8px 10px;border:1px solid #e5e7eb;"><strong>standard</strong></td>
          <td style="padding:8px 10px;border:1px solid #e5e7eb;text-align:center;color:#059669;font-weight:600;">≈ 0,04 $</td>
          <td style="padding:8px 10px;border:1px solid #e5e7eb;text-align:center;color:#059669;">≈ 0,08 $</td>
          <td style="padding:8px 10px;border:1px solid #e5e7eb;color:#374151;">Illustrations courantes</td>
        </tr>
        <tr style="background:#fafafa;">
          <td style="padding:8px 10px;border:1px solid #e5e7eb;"><strong>hd</strong></td>
          <td style="padding:8px 10px;border:1px solid #e5e7eb;text-align:center;color:#2563eb;font-weight:600;">≈ 0,08 $</td>
          <td style="padding:8px 10px;border:1px solid #e5e7eb;text-align:center;color:#2563eb;">≈ 0,12 $</td>
          <td style="padding:8px 10px;border:1px solid #e5e7eb;color:#6b7280;">Illustrations haute résolution</td>
        </tr>
      </tbody>
    </table>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px;">
        ...
        <div>
          ...
          <select id="sim-model" style="width:100%;padding:7px;border:1px solid #d1d5db;border-radius:6px;font-size:.85rem;">
            ...
            <option value="dall-e-3-standard">DALL-E 3 · standard</option>
      ...
      <div style="padding:20px 28px 24px;overflow-y:auto;flex:1;">
        ...
        <div id="tab-generate">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px;">
            ...
            <label id="lbl-dalle3" style="display:flex;align-items:center;gap:8px;padding:10px 12px;border:2px solid #e5e7eb;border-radius:8px;cursor:pointer;background:#f9fafb;">
              <input type="radio" name="imageia-model" value="dall-e-3">
              <div>
                <div style="font-weight:700;color:#2563eb;font-size:.88rem;">DALL-E 3
                  <span style="background:#2563eb;color:#fff;font-size:.64rem;padding:1px 6px;border-radius:99px;margin-left:4px;">CLASSIQUE</span>
                </div>
                <div style="font-size:.74rem;color:#6b7280;">Illustrations artistiques, scènes narratives</div>
              </div>
            </label>
          </div>
...
function openImageIADialog(editor, apiKey) {
  ...
  wrapper.querySelectorAll('input[name="imageia-model"]').forEach(radio => {
    radio.addEventListener('change', () => {
      ...
      $('lbl-dalle3').style.border = m === 'dall-e-3' ? '2px solid #2563eb' : '2px solid #e5e7eb';
      $('lbl-dalle3').style.background = m === 'dall-e-3' ? '#eff6ff' : '#f9fafb';
